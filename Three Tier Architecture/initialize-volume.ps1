...
<powershell>
 ...
 #>
  ...
  <#The goal is to attach a user data script that will initialize volumes in Windows OS for the 
EBS volumes that are attached to each EC2 instance. This will be accomplished by a user data script 
trigger the powershell script upon ec2 launch. Currently the below script doesnt work as intended. Will revise.#>
