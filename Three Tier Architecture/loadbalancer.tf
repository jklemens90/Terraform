...
associate DNS records to the load balancer apply SSL cert to load balancer. Waiting for domain to transfer to AWS

change ELB to an ALB
add a target group consisting of the 2 web servers. 
*/
...
resource "aws_lb" "App_Server_NLB" {
  name               = "app-server-nlb"
